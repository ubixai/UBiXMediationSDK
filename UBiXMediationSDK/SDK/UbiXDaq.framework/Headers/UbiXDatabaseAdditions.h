...
/** Category of additions for @c UbiXDatabase  class.
...
@interface UbiXDatabase (UbiXDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `UbiXResultSet` of schema; @c nil  on error.
 
 @see [SQLite File Format](https://sqlite.org/fileformat.html)
 */

- (UbiXResultSet * _Nullable)getSchema;
...
- (UbiXResultSet * _Nullable)getTableSchema:(NSString*)tableName;
