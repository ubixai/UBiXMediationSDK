...
#pragma mark - UbiXGPBFieldMaskRoot
 ...
 **/
UbiX_GPB_FINAL @interface UbiXGPBFieldMaskRoot : UbiXGPBRootObject
@end

#pragma mark - UbiXGPBFieldMask

typedef UbiX_GPB_ENUM(UbiXGPBFieldMask_FieldNumber) {
  UbiXGPBFieldMask_FieldNumber_PathsArray = 1,
};
 ...
 **/
UbiX_GPB_FINAL @interface UbiXGPBFieldMask : UbiXGPBMessage
