 ...
 **/
UbiX_GPB_FINAL @interface UbiXGPBEmptyRoot : UbiXGPBRootObject
@end

#pragma mark - UbiXGPBEmpty
 ...
 **/
UbiX_GPB_FINAL @interface UbiXGPBEmpty : UbiXGPBMessage
