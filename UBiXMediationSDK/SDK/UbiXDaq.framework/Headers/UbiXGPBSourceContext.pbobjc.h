...
#pragma mark - UbiXGPBSourceContextRoot
 ...
 **/
UbiX_GPB_FINAL @interface UbiXGPBSourceContextRoot : UbiXGPBRootObject
@end

#pragma mark - UbiXGPBSourceContext

typedef UbiX_GPB_ENUM(UbiXGPBSourceContext_FieldNumber) {
  UbiXGPBSourceContext_FieldNumber_FileName = 1,
};
 ...
 **/
UbiX_GPB_FINAL @interface UbiXGPBSourceContext : UbiXGPBMessage
