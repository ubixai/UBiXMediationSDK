 ...
 **/
UbiX_GPB_FINAL @interface UbiXGPBAnyRoot : UbiXGPBRootObject
@end

#pragma mark - UbiXGPBAny

typedef UbiX_GPB_ENUM(UbiXGPBAny_FieldNumber) {
  UbiXGPBAny_FieldNumber_TypeURL = 1,
  UbiXGPBAny_FieldNumber_Value = 2,
};
 ...
 *     }
 **/
UbiX_GPB_FINAL @interface UbiXGPBAny : UbiXGPBMessage
