...
#pragma mark - UbiXGPBDurationRoot
 ...
 **/
UbiX_GPB_FINAL @interface UbiXGPBDurationRoot : UbiXGPBRootObject
@end

#pragma mark - UbiXGPBDuration

typedef UbiX_GPB_ENUM(UbiXGPBDuration_FieldNumber) {
  UbiXGPBDuration_FieldNumber_Seconds = 1,
  UbiXGPBDuration_FieldNumber_Nanos = 2,
};
 ...
 **/
UbiX_GPB_FINAL @interface UbiXGPBDuration : UbiXGPBMessage
