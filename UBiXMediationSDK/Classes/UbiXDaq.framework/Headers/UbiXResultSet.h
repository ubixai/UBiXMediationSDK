...
/** Represents the results of executing a query on an @c UbiXDatabase .
...
@interface UbiXResultSet : NSObject

@property (nonatomic, retain, nullable) UbiXDatabase *parentDB;
...
/** `UbiXStatement` used by result set. */

@property (atomic, retain, nullable) UbiXStatement *statement;
