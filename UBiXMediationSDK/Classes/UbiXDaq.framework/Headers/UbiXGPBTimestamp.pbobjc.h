...
#pragma mark - UbiXGPBTimestampRoot
 ...
 **/
UbiX_GPB_FINAL @interface UbiXGPBTimestampRoot : UbiXGPBRootObject
@end

#pragma mark - UbiXGPBTimestamp

typedef UbiX_GPB_ENUM(UbiXGPBTimestamp_FieldNumber) {
  UbiXGPBTimestamp_FieldNumber_Seconds = 1,
  UbiXGPBTimestamp_FieldNumber_Nanos = 2,
};
 ...
 **/
UbiX_GPB_FINAL @interface UbiXGPBTimestamp : UbiXGPBMessage
